...
//            var autoCat = LookupRepository.GetEntities<NoteCatalog>()
//                .FirstOrDefault(c => c.Name == AutomobileConstant.AutoMobileInfoCatalogName);
//            Assert.NotNull(autoCat);
//            var autoNoteSerializer = new AutomobileXmlNoteSerialize(Application, new NullLogger<AutomobileInfo>(), LookupRepository);
//            _autoManager = new AutomobileManager(autoNoteSerializer, new AutomobileValidator(LookupRepository), noteManager, LookupRepository);

//            // setup discount manager
//            var discountCat = LookupRepository.GetEntities<NoteCatalog>()
...
//            var logCat = LookupRepository.GetEntities<NoteCatalog>()
//                .FirstOrDefault(c => c.Name == AutomobileConstant.GasLogCatalogName);
//            Assert.NotNull(logCat);
//            var gasLogNoteSerializer = new GasLogXmlNoteSerialize(Application, new NullLogger<GasLog>(), _autoManager, _discountManager, LookupRepository);
//            _manager = new GasLogManager(gasLogNoteSerializer, new GasLogValidator(LookupRepository, DateProvider), noteManager, _autoManager, LookupRepository, DateProvider);
