...
//            Assert.Equal(_author.Id.ToString(), gasLog.AuthorId.ToString());
//        }
...
//            var autoManager = new AutomobileManager(autoNoteSerializer, new AutomobileValidator(LookupRepository), noteManager, LookupRepository);
...
//            var discountManager = new DiscountManager(discountNoteSerializer, new GasDiscountValidator(LookupRepository), noteManager, LookupRepository);
...
//            _noteSerializer = new GasLogXmlNoteSerialize(Application, new NullLogger<GasLog>(), autoManager, discountManager, LookupRepository);
