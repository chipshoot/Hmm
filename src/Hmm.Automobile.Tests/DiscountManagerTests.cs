...
//            var noteSerializer = new GasDiscountXmlNoteSerialize(Application, new NullLogger<GasDiscount>(), LookupRepository);
//            var noteManager = new HmmNoteManager(NoteRepository, new NoteValidator(NoteRepository), DateProvider);
//            _manager = new DiscountManager(noteSerializer, new GasDiscountValidator(LookupRepository), noteManager, LookupRepository);
