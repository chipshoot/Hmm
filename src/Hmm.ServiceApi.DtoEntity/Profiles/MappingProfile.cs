...
//            CreateMap<ApiAuthorForUpdate, AuthorDb>();
//            CreateMap<AuthorDb, ApiAuthorForUpdate>();
//            CreateMap<PageList<AuthorDb>, PageList<ApiAuthor>>()
//                .ConvertUsing(new PageListConverter<AuthorDb, ApiAuthor>());
...
//                .ForMember(n => n.Author, opt => opt.MapFrom(s => new AuthorDb { Id = s.AuthorId }))
