...
//            var newUser = LookupRepository.GetEntities<AuthorDb>().FirstOrDefault(u => u.AccountName != "jfang");
...
//        {
//            public FakeValidator(IVersionRepository<HmmNote> noteRepository) : base(noteRepository)
//            {
//            }
...
//        {
//            InsertSeedRecords();
//            _user = LookupRepository.GetEntities<AuthorDb>().FirstOrDefault();
