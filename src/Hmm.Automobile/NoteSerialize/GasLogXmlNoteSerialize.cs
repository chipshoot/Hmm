    ...
    public class GasLogXmlNoteSerialize : EntityXmlNoteSerializeBase<GasLog>
    {
        ...
        public override GasLog GetEntity(HmmNote note)
        {
            try
            {
                ...
                var gasLog = new GasLog
                {
                    ...
                    Odometer = gasLogRoot.Element(ns + "CurrentMeterReading")?.GetDimension() ?? 0.GetKilometer(),
                    Fuel = gasLogRoot.Element(ns + "Gas")?.GetVolume() ?? 0d.GetDeciliter(),
        ...
        public override string GetNoteSerializationText(GasLog entity)
        {
            ...
            var xml = new XElement(AutomobileConstant.GasLogRecordSubject,
                ...
                new XElement("CurrentMeterReading", entity.Odometer.SerializeToXml(ContentNamespace)),
                new XElement("Gas", entity.Fuel.SerializeToXml(ContentNamespace)),
